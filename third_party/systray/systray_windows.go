...
// SetIconName is a no-op on Windows: themed icon-name lookup is a Linux
// StatusNotifierItem feature. Callers still SetIcon a pixmap here.
func SetIconName(string) {}

// SetIconThemePath is a no-op on Windows (see SetIconName).
func SetIconThemePath(string) {}
