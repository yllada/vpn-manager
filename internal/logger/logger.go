// Package logger provides structured logging utilities for VPN Manager.
...
// This interface can be used for dependency injection in tests.
...
// Ensure AppLogger implements Logger interface.
